import { supabaseChallengeService } from './src/services/supabase.challenges.service';
...
const sampleChallenges = [
  {
    ...
    predetermined_activities: [
      { title: 'Morning Workout', emoji: '🏃', frequency: 'daily' as const },
      { title: 'Evening Workout', emoji: '🏋️', frequency: 'daily' as const },
      { title: 'Drink 1 Gallon Water', emoji: '💧', frequency: 'daily' as const },
      { title: 'Read 10 Pages', emoji: '📖', frequency: 'daily' as const },
      { title: 'Progress Photo', emoji: '📸', frequency: 'daily' as const },
    ],
    badge_emoji: '🏆',
  ...
  },
  {
    ...
    predetermined_activities: [
      { title: 'Morning Meditation', emoji: '🌅', frequency: 'daily' as const },
    ],
    badge_emoji: '🧘',
  ...
  },
  {
    ...
    predetermined_activities: [
      { title: 'Wake up at 5 AM', emoji: '🌅', frequency: 'daily' as const },
      { title: 'Morning Routine', emoji: '☕', frequency: 'daily' as const },
    ],
    badge_emoji: '🌟',
  ...
  },
  {
    ...
    success_threshold: 80,
    predetermined_activities: [
      { title: 'Read 30 Minutes', emoji: '📖', frequency: 'daily' as const },
      { title: 'Book Review', emoji: '✍️', frequency: 'weekly' as const },
    ],
    badge_emoji: '📚',
    badge_name: 'Bookworm',
    has_forum: true,
  },
  {
    ...
    predetermined_activities: [
      { title: 'Meal Prep', emoji: '🍱', frequency: 'daily' as const },
      { title: 'Food Journal', emoji: '📝', frequency: 'daily' as const },
    ],
    badge_emoji: '🥗',
  ...
  },
  {
    ...
    success_threshold: 90,
    predetermined_activities: [
      { title: '100 Push-ups', emoji: '💪', frequency: 'daily' as const },
    ],
    badge_emoji: '💪',
  ...
  },
  {
    ...
    success_threshold: 85,
    predetermined_activities: [
      { title: 'Gratitude Journaling', emoji: '✍️', frequency: 'daily' as const },
    ],
    badge_emoji: '🙏',
  ...
  },
  {
    ...
    success_threshold: 80,
    predetermined_activities: [
      { title: 'Stay Off Social Media', emoji: '🚫', frequency: 'weekly' as const },
      { title: 'Offline Activity', emoji: '🎨', frequency: 'weekly' as const },
    ],
    badge_emoji: '🧘',
  ...
  },
  {
    ...
    success_threshold: 85,
    predetermined_activities: [
      { title: '10K Steps', emoji: '👟', frequency: 'daily' as const },
    ],
    badge_emoji: '🏃',
  ...
  },
  {
    ...
    description: 'End every shower with 2 minutes of cold water. Build mental resilience and boost recovery.',
    emoji: '🚿',
    type: 'streak' as const,
    scope: 'global' as const,
    duration_days: 21,
    success_threshold: 90,
    predetermined_activities: [
      { title: 'Cold Shower', emoji: '❄️', frequency: 'daily' as const },
    ],
    badge_emoji: '❄️',
    badge_name: 'Ice Cold',
    has_forum: true,
...
async function createSampleChallenges() {
  ...
  for (const challenge of sampleChallenges) {
    ...
    try {
      const result = await supabaseChallengeService.createChallenge(challenge);
      if (result.success) {
        console.log(`✅ Created: ${challenge.name}`);
      } else {
        console.log(`❌ Failed: ${challenge.name} - ${result.error}`);
      }
    } catch (error) {
  ...
  console.log('\n✨ Done creating sample challenges!');
}
