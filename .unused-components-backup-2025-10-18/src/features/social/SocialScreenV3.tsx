...
const styles = StyleSheet.create({
  ...
  // OLD Check-in post styles - COMPACT VERSION (keeping for reference)
  checkinCardCompact: {
    ...
    shadowRadius: 12,
    elevation: 4,
    marginHorizontal: -12, // Extend to full width of postContent
  },
  checkinAccentBar: {
    position: 'absolute',
    top: 0,
  ...
  checkinCompactContent: {
    flex: 1,
  },
  checkinCompactAction: {
    fontSize: 16,
    fontWeight: '600',
    color: '#FFFFFF',
    marginBottom: 4,
  ...
  checkinCompactStreakEmoji: {
    fontSize: 16,
  },
  checkinCompactStreakNumber: {
    fontSize: 14,
    fontWeight: '700',
    color: '#FFD700',
  },
  // OLD Check-in post styles (keeping for reference)
  checkinCard: {
    backgroundColor: 'rgba(10, 10, 12, 0.5)', // Dark background like other cards
    borderRadius: 20,
    borderWidth: 1,
    borderColor: 'rgba(255,215,0,0.25)', // Stronger gold border for celebration
    padding: 16,
    overflow: 'hidden',
    position: 'relative',
    // Celebration glow
  ...
  checkinHero: {
    flexDirection: 'row',
    alignItems: 'center', // Center align for better look
    gap: 14,
    marginBottom: 12,
    paddingVertical: 8,
  },
  ...
  checkinMilestone: {
    ...
    paddingBottom: 4,
    borderTopWidth: 1,
    backgroundColor: 'rgba(255, 215, 0, 0.03)', // Very subtle gold background
  },
